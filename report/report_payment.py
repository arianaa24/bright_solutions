...
class ReportAbstractPayment(models.AbstractModel):
    _name = 'bright_solutions.abstract.reporte_account_payment'
...
class ReportPayment1(models.AbstractModel):
    _name = 'report.bright_solutions.reporte_account_payment1'
    _inherit = 'bright_solutions.abstract.reporte_account_payment'
    
class ReportPayment2(models.AbstractModel):
    _name = 'report.bright_solutions.reporte_account_payment2'
    _inherit = 'bright_solutions.abstract.reporte_account_payment'

class ReportPayment3(models.AbstractModel):
    _name = 'report.bright_solutions.reporte_account_payment3'
    _inherit = 'bright_solutions.abstract.reporte_account_payment'
